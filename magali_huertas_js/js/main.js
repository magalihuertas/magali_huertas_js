...
/* Jquery con API para traer una lista de perros con filtro por raza, resultado: foto y características del animal */
...
function buscarRaza(search_str) {
  let string_length = search_str.length 
  search_str = search_str.toLowerCase(); 
  for (let i = 0; i < breeds.length; i++) 
  {
    let breed_name_snippet = breeds[i].name.substr(0, string_length).toLowerCase(); 
...
// muestra las imagenes y los datos del perro
